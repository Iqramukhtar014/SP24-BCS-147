...
class CompletedTasksPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<TaskProvider>(builder: (context, prov, _) {
      final tasks = prov.completedTasks();
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) => CompletedTile(task: tasks[index]),
      );
    });
  }
}
...
class CompletedTile extends StatelessWidget {
  final Task task;
  const CompletedTile({super.key, required this.task});
